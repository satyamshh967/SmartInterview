    ...
    <div className="flex flex-col h-full bg-[#0D121F] rounded-2xl border border-white/5 overflow-hidden shadow-2xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-2.5 bg-slate-900/80 border-b border-white/5">
        <div className="flex items-center gap-3">
          ...
          {statusBadge && (
            <span className="hidden sm:inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[11px] font-medium bg-indigo-500/10 text-indigo-300 border border-indigo-500/20">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={isEvaluating}
            className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-semibold text-white bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 active:scale-95 rounded-lg shadow-sm shadow-indigo-500/30 transition-all disabled:opacity-50"
          >
            {isEvaluating ? (
